...
A maintenance checklist, not a refactoring license: report findings, apply only safe fixes, and ship anything code-changing through the `AGENTS.md` ship flow.
