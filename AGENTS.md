...
This file is the canonical source of truth for repository rules and conventions. It is exposed as `CLAUDE.md` (Claude Code) and `.agents/rules/workspace-rules.md` (Antigravity).
