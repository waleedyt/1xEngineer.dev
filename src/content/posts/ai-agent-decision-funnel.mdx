...
<p class="text-center text-xs -mt-2 mb-6 italic" style="color: var(--color-muted);">The HTML interface displaying the append-only ledger of categorized decisions with review status.</p>
